...
- 긴 단일 문단을 body 예산 이하로 나누고, 다른 문서의 rank가 사이에 있어도 source line이 인접한 chunk를 병합한다.
...
최종 corpus 재생성 결과는 active Markdown 12개와 chunk 144개다. 선택된 small/hybrid의 실제 Hook 요청 지연시간은 p50 2778.64 ms, p95 2803.30 ms였다.
